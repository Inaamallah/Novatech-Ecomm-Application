...
const ProductCard = ({ image, category, title, description, price, oldPrice, badge, rating,_id }) => {
    return (
                ...
                <div className="p-4">
                    ...
                    <div className="mt-3 flex items-center justify-between">
                        <div>
                            ...
                            {oldPrice && <div className="text-sm text-gray-400 line-through">PKR {oldPrice}</div>}
                        </div>
